...
https://static-assets.codecademy.com/Courses/Learn-JavaScript/Modules/WorkAround%20Explorer%20Demo.gif
...
This took me a while to get through...mostly due to a rounding issue that you run into when you enter very large numbers into the formatNumber function that I ran into during testing. This doesn't actually happen w/ the numbers from the project, but it's why I ended up logging to the console when a very large number is entered.